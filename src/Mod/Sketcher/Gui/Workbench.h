...
SketcherGuiExport void addSketcherWorkbenchAutoConstraints(Gui::MenuItem& autoconstraints);
...
SketcherGuiExport void addSketcherWorkbenchAutoConstraints(Gui::ToolBarItem& autoconstraints);
