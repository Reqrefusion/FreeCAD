...
public:
    ...
    HitResult findClosestElement(Sketcher::SketchObject* sketch,
...
private:
    ...
    int addSourceReference(Sketcher::SketchObject* sketch,
                           App::DocumentObject* sourceObject,
                           const std::string& subName,
                           bool intersection,
    ...
    const Element* findElementBySource(App::DocumentObject* sourceObject,
                                       const std::string& subName,
    ...
    void createNodes();
    void resetNodes();
    void rebuildFromSourceObjects(Sketcher::SketchObject* sketch,
                                  const std::vector<Source>& sources,
                                  std::vector<std::string> sourceNames);
    bool ensurePreview(Sketcher::SketchObject* sketch, Element& element);
    void appendElementToCoin(const Element& element,
