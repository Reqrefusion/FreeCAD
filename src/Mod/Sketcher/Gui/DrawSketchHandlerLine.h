    ...
    void updateDataAndDrawToPosition(Base::Vector2d onSketchPos) override
    {
        switch (state()) {
            case SelectMode::SeekFirst: {
                ...
                startPoint = getLineExtensionAutoConstraintSnapPoint(snapPoint) ? snapPoint : onSketchPos;
            ...
            case SelectMode::SeekSecond: {
                ...
                Base::Vector2d snapPoint;
                endPoint = getLineExtensionAutoConstraintSnapPoint(snapPoint) ? snapPoint : onSketchPos;
