...
public:
    ...
    int materializeLazyExternalSourceReference(const std::string& sourceObjectName,
    ...
    bool getLazyExternalSourceReference(int lazyExternalId,
...
private:
    ...
    */
    ...
    int preselectLazyExternalAtCursor(const SbVec2s& cursorPos,
                                       const Gui::View3DInventorViewer* viewer,
                                       bool& vertex);
